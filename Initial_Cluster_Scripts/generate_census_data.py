...
"""This script is used to iterate census tracts, converting annual data to monthly via linerar interporation. Data is also pivoted from original DB structure. 
...
def pivot_census_data(unpivoted_dataframe,census_tract):
    ...
    census_dataframe.to_csv('pivoted.csv')
